...
- привязка ранее купленных на сайте подписок к Telegram требует отдельного подтверждённого bind-flow; покупки, созданные непосредственно ботом, привязываются автоматически;
