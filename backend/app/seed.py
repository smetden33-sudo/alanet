...
PLANS = [
    {"slug": "start", "name": "Старт", "duration_days": 30, "traffic_limit_bytes": 100 * 1024**3, "device_limit": 2, "price_rub": Decimal("299.00")},
    {"slug": "calm", "name": "Спокойно", "duration_days": 90, "traffic_limit_bytes": 300 * 1024**3, "device_limit": 3, "price_rub": Decimal("749.00")},
