...
def _translate_node_audit_message(message: str) -> str:
    ...
    translations = (
        ...
        (": registry country ", ": страна в реестре "),
        (", Remnawave country ", ", страна в Remnawave "),
        (": registry status is not active, but node still exists in Remnawave.", ": в реестре нода не активна, но всё ещё существует в Remnawave."),
